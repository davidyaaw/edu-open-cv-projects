...
class CaptureManager(object):
    ...
    def enterFrame(self):
        ...
        # But first check if any previous frame was exited
    ...
    def exitFrame(self):
        ...
        # Draw to the window, if any to draw
    ...
    def _writeVideoFrame(self):
        ...
        if self._videoWriter is None:
            ...
            if np.isnan(fps) or fps <= 0.0:
                # The capture's fps if unknown so use estimate/
